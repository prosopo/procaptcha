...
export class ProsopoContract extends ProsopoContractBase {
    ...
    public async dappUserCommit(signer: Signer, dappAccount: string, captchaDatasetId: string, userMerkleTreeRoot: string, providerAddress: string): Promise<Partial<TransactionResponse>> {
